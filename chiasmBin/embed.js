...
return t.setAttribute("frameborder","0"),t.style.border="0",t.scrolling="no",void 0!==e.width?t.style.width=e.width+("yes"===e.percent?"%":"px"):t.style.width="100%",t.src=e.protocol+"//"+m+e.id+".html?auto",t},r=function(e){e=decodeURIComponent(e)
