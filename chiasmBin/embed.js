...
f.push(l),t.parentElement.insertBefore(l.elem,t)}},l=function(e){for(var t=0;t<f.length;t++)if(f[t].elem.contentWindow===e)return f[t]},d=function(e,t){var i=l(e.source)
...
var h="192.168.100.3:8080/chiasmBin/embed.js",m="192.168.100.3:8080/",f=[]
